...
function getConfig(params) {
  ...
  const { accessKeyId, secretAccessKey, bucket, region } = params;
  const _DEFAULT_BUCKET_NAME = `--undefined-bucket-name-${uuid.v4()}`;
...
async function apiSignS3Url(filename, filetype) {
  ...
  const signed_url = await s3RequestPresigner.getSignedUrl(client, command, { expiresIn: 3600 });
...
exports.apiSignS3Url = apiSignS3Url;
exports.demo = demo;
exports.fetchPresignedUrl = fetchPresignedUrl;
exports.getConfig = getConfig;
exports.getS3Client = getS3Client;
exports.getS3ClientNative = getS3ClientNative;
